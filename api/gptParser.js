...
export default async function handler(req, res) {
  ...
  systemPrompt =
    ...
    "Если штрихкод даёт только название и бренд, но нет КБЖУ, тогда выполни поиск на сайте "wwww.fatsecret.ru/калории-питание/" по названию и добавь КБЖУ на 100 г продукта. " +
    "Если продукт не найден, искать в другом месте. " +
    ...
    "Если продукт не найден вообще, либо найдено только название а КБЖ н енайдено — верни {\"notFound\": true}. " +
