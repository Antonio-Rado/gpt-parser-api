...
export default async function handler(req, res) {
  ...
  systemPrompt =
    ...
    "Если штрихкод даёт только название и бренд, но нет КБЖУ, тогда выполни поиск на сайте "wwww.fatsecret.ru/калории-питание/" по названию и найди КБЖУ на 100 г продукта. " +
    "Если продукт не найден, искать на других сайтах. " +
    "Калории считать по формуле "калории = белок*4 + жир*9 + углеводы*9", использовать это число. " +
  ...
  effectiveUseSearch = true; // 🔎 включаем веб-поиск
}
