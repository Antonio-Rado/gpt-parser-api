...
export default async function handler(req, res) {
  ...
  systemPrompt =
    ...
    "Если штрихкод даёт только название и бренд, но нет КБЖУ, тогда выполни поиск по названию и добавь КБЖУ на 100 г продукта. " +
    ...
    "Если продукт не найден вообще — верни {\"notFound\": true}. " +
